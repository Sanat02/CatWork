...
public final class ActiveCat {
    ...
    public static String dance(){return "Я танцую!";}

    public static String meow(){return "Я мурлыкаю!";}

    public static String wash(){return "Я моюсь!";}
    /*****/
}
interface Func<T> {
    T perform();
